...
export class Backend implements backendInterface {
    ...
    async getAllDealers(): Promise<Array<Dealer>> {
    ...
    async getDealersByCity(arg0: string): Promise<Array<Dealer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDealersByCity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDealersByState(arg0: string): Promise<Array<Dealer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDealersByState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: Inquiry): Promise<boolean> {
        if (this.processError) {
            try {
